...
class EventSeeder extends Seeder
{
    ...
    // 10 columns/row, so the per-insert bind count must stay under SQLite's
    // SQLITE_MAX_VARIABLE_NUMBER (32766 on 3.32+). 4000*10 = 40000 overflowed it
    // and broke the default seed; 3000*10 = 30000 is safe on the default driver.
    private const CHUNK = 3000;
