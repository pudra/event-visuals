...
<template>
    ...
    <div class="flex h-[calc(100dvh-4rem)] flex-col">
        ...
        <div class="relative flex-1">
            ...
            >
                <span class="text-muted-foreground">Couldn't load the map.</span>
                <button
                    type="button"
            ...
            <div
                ...
                class="absolute top-4 right-4 z-[500] w-72 animate-in overflow-hidden rounded-xl border border-border bg-background shadow-2xl outline-none focus:ring-2 focus:ring-ring fade-in slide-in-from-right-3"
            >
                <img
                ...
                <div class="p-4">
                    ...
                    <p class="mt-2 text-sm text-muted-foreground">
                        <span aria-hidden="true">📍</span> {{ selected.city }} · {{ selected.venue_name }}
                    </p>
                    <p class="text-sm text-muted-foreground">
                        <span aria-hidden="true">🗓</span> {{ formatDateTime(selected.starts_at_iso) }}
                    </p>
